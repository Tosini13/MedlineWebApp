...
import { eventsByLineQueryOptions, useDeleteEvent } from "@/features/events/events.queries";
    ...
    <div className="space-y-6">
      ...
      {eventsQuery.isLoading ? (
        ...
        <EmptyState
          ...
          description="The events table may be missing. Run pnpm db:push to apply database migrations."
          action={
            <Button asChild variant="outline">
              <Link to="/lines/$lineId/events/new" params={{ lineId }}>
                Try adding an event
